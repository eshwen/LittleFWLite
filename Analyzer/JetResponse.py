...
class JetResponse(JetAnalyzer):
	def beginJob(self):
        ...
        self.outFile = ROOT.TFile(outFilePath,"RECREATE")i
        self.hists["jetResponse"] = ROOT.TH1D("JetResponse"," ; Jet Response ;  ",50,0.5,2.)
        self.hists["recoJetPt_vs_genJetPt"] = ROOT.TH1D("recoJetPt_vs_genJetPt"," ; RECO Jet p_{T} ; GEN Jet p_{T}  ",50,0.,100.,50,0.,100.)
